...
impl<'a> Scheduler<'a> {
    fn init(opts: &Opts, open_object: &'a mut MaybeUninit<OpenObject>, object: &'a mut MaybeUninit<Object>) -> Result<Self> {
        ...
        let mut skel = scx_ops_load!(skel, object, mitosis, uei)?;
